...
<head>
    <title>Agriculture Equipment Rental Sysytem | Rent Report</title>
...
<body>
   ...
   <?php include_once('includes/sidebar.php');?>
       ...
       <?php include_once('includes/header.php');?>
            ...
            <!-- main-heading -->
            <h2 class="main-title-w3layouts mb-2 text-center">Rent Report</h2>
            <!--// main-heading -->
...
<h4 class="header-title m-t-0 m-b-30" style="text-align: center;">Rent Report Month Wise</h4>
<h4 align="center" style="color:blue;padding-top: 10px" >Rent Report  from <?php echo $m1."-".$y1;?> to <?php echo $m2."-".$y2;?></h4>
<hr />
...
$y2=date("Y",$year2);
 ?>
 <h4 class="header-title m-t-0 m-b-30">Rent Report Year Wise</h4>
    <h4 align="center" style="color:blue">Rent Report  from <?php echo $y1;?> to <?php echo $y2;?></h4>
    <hr />
                  <table class="table table-bordered">
                    <thead>
<tr>
